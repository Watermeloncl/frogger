  ...
  render() {
    ...
    return (
      <div id="0" className="back">
        ...
        <div><img id="6" className="car carFive" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-car-128x128.png"></img></div>
        <div><img id="7" className="car carSix" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-car-128x128.png"></img></div>

        <div><img id="8" className="car carSeven" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-racing-car-128x128.png"></img></div>
        <div><img id="9" className="car carEight" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-racing-car-128x128.png"></img></div>
        <div><img id="10" className="car carNine" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-racing-car-128x128.png"></img></div>

        <div><img id="11" className="car carTen" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-car-128x128.png"></img></div>
        <div><img id="12" className="car carEleven" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-car-128x128.png"></img></div>
        <div><img id="13" className="car carTwelve" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-car-128x128.png"></img></div>

        <div><img id="14" className="car carThirteen" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-racing-car-128x128.png"></img></div>
        <div><img id="15" className="car carFourteen" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-racing-car-128x128.png"></img></div>
        <div><img id="16" className="car carFifteen" src="http://www.classicgaming.cc/classics/frogger/images/icons/icon-frogger-pixel-racing-car-128x128.png"></img></div>
